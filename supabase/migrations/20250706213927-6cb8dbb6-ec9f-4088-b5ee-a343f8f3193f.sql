...
-- Insert 44 New Verified Coin Sources from User List
...
('Numismática Visual', 'https://www.numismatica-visual.com', 'database', 'ES', 'es', 2, 0.82, true, '{"spanish_coins"}'),
...
('Künker', 'https://www.kuenker.de', 'auction_house', 'DE', 'de', 1, 0.95, true, '{"german_coins", "european"}'),
...
-- Precious Metals Sources to be moved to bullion table
('Valcambi', 'https://www.valcambi.com', 'dealer', 'CH', 'en', 1, 0.92, true, '{"precious_metals", "bars"}'),
('Oxford Gold Group', 'https://www.oxfordgoldgroup.com', 'dealer', 'US', 'en', 2, 0.88, true, '{"gold", "investment"}'),
('BullionVault', 'https://www.bullionvault.com', 'dealer', 'GB', 'en', 1, 0.90, true, '{"gold", "silver", "storage"}'),
('Silver Gold Bull', 'https://www.silvergoldbull.com', 'dealer', 'CA', 'en', 2, 0.87, true, '{"silver", "gold"}'),
('Zahngold Börse', 'https://www.zahngoldboerse.de', 'dealer', 'DE', 'de', 3, 0.75, true, '{"dental_gold", "scrap"})
...
('Zahngold Börse', 'https://www.zahngoldboerse.de', 'scrap_dealer', 'DE', 'de', 3, 0.78, true, '{"gold", "dental_gold"}');
