...
-- Step 1: Add specialization column to existing global_coin_sources table
ALTER TABLE public.global_coin_sources ADD COLUMN IF NOT EXISTS specialization TEXT[] DEFAULT '{}';

-- Step 2: Create new tables for expanded AI Brain categories
