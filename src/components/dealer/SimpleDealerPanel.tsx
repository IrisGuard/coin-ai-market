  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const coinData = {
        ...
        listing_type: listingType === 'auction' ? 'auction' : 'direct_sale',
        starting_bid: listingType === 'auction' ? parseFloat(formData.startingBid) || parseFloat(formData.price) : null,
        reserve_price: listingType === 'auction' ? parseFloat(formData.reservePrice) || null : null,
        auction_end: listingType === 'auction' ? new Date(Date.now() + parseInt(formData.auctionDuration) * 24 * 60 * 60 * 1000).toISOString() : null,
