      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold text-purple-600 ml-2">CoinVision</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-green-500 transition-colors">Press</a></li>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-center">
          <p className="text-gray-500">
            © 2024 <span className="text-purple-600 font-semibold">CoinVision</span>. All rights reserved. | Empowering numismatists worldwide with AI technology.
          </p>
        </div>
      </div>
    </footer>
