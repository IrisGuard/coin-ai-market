...
export const ReferralsCard = () => {
  ...
  if (!referralData) {
    return (
        <div className="glass-card rounded-3xl bg-gradient-to-br from-[#00ff88]/20 via-white/90 to-[#0070fa]/20 border-2 border-[#00ff88]/70 shadow-xl p-6 animate-fade-in">
            <h3 className="font-extrabold text-xl mb-4 bg-gradient-to-r from-[#0070fa] via-[#00ff88] to-[#00d4ff] bg-clip-text text-transparent animate-glow">Premium Referral Program</h3>
            <p className="text-sm font-semibold bg-gradient-to-r from-[#0070fa] to-[#00ff88] bg-clip-text text-transparent text-center py-4">Join our referral program to earn bonus GCAI tokens!</p>
        </div>
    )
  }
  ...
  return (
    <div className="glass-card rounded-3xl bg-gradient-to-br from-[#00ff88]/20 via-white/90 to-[#0070fa]/20 border-2 border-[#00ff88]/70 shadow-xl p-6 animate-fade-in">
      <h3 className="font-extrabold text-xl mb-5 bg-gradient-to-r from-[#0070fa] via-[#00ff88] to-[#00d4ff] bg-clip-text text-transparent animate-glow">Your Referral Network</h3>
      <div className="space-y-4">
        ...
        <div className="mt-5">
            <label className="text-sm font-bold bg-gradient-to-r from-[#0070fa] to-[#00ff88] bg-clip-text text-transparent">Your Personal Referral Code</label>
            <div className="relative mt-2">
             ...
             <p className="text-xs font-semibold bg-gradient-to-r from-[#0070fa] to-[#00ff88] bg-clip-text text-transparent text-center mt-2">Click to copy • Share and earn bonus GCAI tokens</p>
        </div>
      </div>
    </div>
  );
